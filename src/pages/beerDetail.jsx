        ...
        <div className="beer-page">
            <div className="beer-info">
                ...
                <div className="beer-info__column">
                    ...
                    <p>
                        <b>Brewed in:</b> {selectedBeer.first_brewed}
                    </p>
                    <p>
                        <b>Yeast:</b> {selectedBeer.ingredients.yeast}
                    </p>
                    <p className="beer-info__description">
                        <em>{selectedBeer.description}</em>
                    </p>
                    ...
                    <p>
                        <b>Food Pairing:</b> {selectedBeer.food_pairing}
                    </p>
                    <p>
                        <b>Tips:</b> {selectedBeer.brewers_tips}
                    </p>
                </div>
            </div>
        </div>
